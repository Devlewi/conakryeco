...
const villeAleatoire =
  villesGuinee[Math.floor(Math.random() * villesGuinee.length)];
  ...
  const options: Intl.DateTimeFormatOptions = {
    ...
    month: "long",
    year: "numeric",
    timeZone: "Africa/Conakry", // Fuseau horaire de la Guinée
  };
          ...
          <div className="inner full">
            ...
            <div className="items items-center ">
              ...
              >
                <h1>
                  <img
                    src={`/${locale}/images/logo-conakry-eco.webp`}
                    className="logo-image logo-image-dark"
                    alt=""
                    srcSet={`/${locale}/images/logo-conakry-eco.webp`}
                  />
