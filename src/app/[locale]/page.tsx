...
export async function generateMetadata({
  ...
  return {
    title: locale === "en" ? "CONAKRY ECO | HOME" : "CONAKRY ECO | ACCUEIL",
    description:
      locale === "en"
        ? "CONAKRY ECO is your economic news portal dedicated to CONAKRY"
        : "CONAKRY ECO est votre portail d'information économique dédié au CONAKRY",
    ...
    twitter: {
      ...
      description:
        locale === "en"
          ? "CONAKRY ECO is your economic news portal dedicated to CONAKRY"
          : "CONAKRY ECO est votre portail d'information économique dédié à la CONAKRY",
